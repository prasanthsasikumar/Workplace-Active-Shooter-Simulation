...
public class ArmSwinger : MonoBehaviour
{
    ...
    public InputActionReference LeftButton, RightButton;
    ...
    private void OnDisable()
    {
        ...
        RightButton.action.Disable();
    }

    /***** FIXED UPDATE *****/
    void FixedUpdate()
    {
        leftButtonPressed = LeftButton.action.ReadValue<float>() == 1;
        rightButtonPressed = RightButton.action.ReadValue<float>() == 1;
    ...
    Quaternion determineAverageControllerRotation()
    {
        ...
        if (leftControllerGameObject != null && rightControllerGameObject != null)
        {
        ...
        else if (leftControllerGameObject != null && rightControllerGameObject == null)
        {
            newRotation = leftControllerGameObject.transform.rotation;
        }
        // Right controller only
        else if (rightControllerGameObject != null && leftControllerGameObject == null)
        {
