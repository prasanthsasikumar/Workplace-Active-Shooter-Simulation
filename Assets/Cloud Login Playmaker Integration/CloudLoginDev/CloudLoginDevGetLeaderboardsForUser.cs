...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Gets all leaderboards for current user.")]
	public class CloudLoginDevGetLeaderboardsForUser : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			CloudLoginUser.CurrentUser.GetLeaderboard(entries, limit, LeaderboardRetrieved);
			Finish();
